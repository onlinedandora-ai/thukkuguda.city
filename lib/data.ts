export interface DirectoryListing {
  id: string;
  name: string;
  category: 'real-estate-developers' | 'aerospace-it-employers' | 'education' | 'healthcare' | 'hospitality-food' | 'retail-services' | 'wellness-healthcare';
...
export const DIRECTORY_LISTINGS: DirectoryListing[] = [
  // Real Estate & Developers
  {
    ...
    image: '/images/orr-exit14.jpg',
    gmapsUrl: 'https://maps.google.com/?q=17.2088,78.4752',
    openingHours: 'Open 9:00 AM - 7:00 PM',
    placeId: 'ChIJ_aspirealty_14',
  },
  {
    ...
    image: '/images/orr-exit14.jpg',
    gmapsUrl: 'https://maps.google.com/?q=17.2115,78.4801',
    openingHours: 'Open 9:30 AM - 6:30 PM',
  },
  {
    ...
    gmapsUrl: 'https://maps.google.com/?q=17.2054,78.4721',
  },
  {
    ...
    gmapsUrl: 'https://maps.google.com/?q=17.2140,78.4880',
  },
  {
    id: 'sri-vahini-townships-thukkuguda',
    name: 'Sri Vahini Townships & Gated Layouts',
    category: 'real-estate-developers',
    categoryLabel: 'Real Estate & Developers',
    description: 'Plotted development project with underground drainage, avenue plantation, and prompt HMDA plot registration services.',
    address: 'ORR Exit 14 Service Road, Thukkuguda, Telangana 501359',
    phone: '+91 98481 22334',
    rating: 4.2,
    reviewCount: 41,
    isVerified: true,
    coordinates: { lat: 17.2100, lng: 78.4770 },
    tags: ['HMDA Layout', 'Avenue Plantation', 'Plot Buying'],
    gmapsUrl: 'https://maps.google.com/?q=17.2100,78.4770',
  },

  // Wellness & Healthcare
  {
    id: 'pranaam-hospital-exit14',
    name: 'Pranaam Hospital - Exit 14 Branch',
    category: 'wellness-healthcare',
    categoryLabel: 'Wellness & Healthcare',
    description: '24/7 multi-specialty emergency trauma care hospital, ICU, outpatient clinics, cardiology, and in-house diagnostic labs.',
    ...
    tags: ['24/7 Emergency', 'Multi-Specialty Hospital', 'ICU', 'Trauma Center'],
    gmapsUrl: 'https://maps.google.com/?q=17.2070,78.4760',
    openingHours: 'Open 24 Hours',
  },
  {
    id: 'sri-lakshmi-nursing-home',
    name: 'Sri Lakshmi Nursing Home & Clinic',
    category: 'wellness-healthcare',
    categoryLabel: 'Wellness & Healthcare',
    description: 'General medical practice, gynecology, maternity care, and pediatric consultation facility serving local resident families.',
    ...
    tags: ['General Physician', 'Maternity Clinic', 'Pediatrics'],
    gmapsUrl: 'https://maps.google.com/?q=17.2040,78.4730',
    openingHours: '8:00 AM - 9:00 PM',
  },
  {
    id: 'apollo-pharmacy-thukkuguda',
    name: 'Apollo Pharmacy 24/7 Express',
    category: 'wellness-healthcare',
    categoryLabel: 'Wellness & Healthcare',
    description: '24-hour retail pharmacy stocking essential pharmaceuticals, health supplements, baby care items, and personal care products.',
    address: 'Srisailam Highway Main Road, Thukkuguda 501359',
    phone: '+91 40 2455 1122',
    rating: 4.4,
    reviewCount: 85,
    isVerified: true,
    isFeatured: true,
    coordinates: { lat: 17.2062, lng: 78.4748 },
    tags: ['24/7 Pharmacy', 'Prescription Medicines', 'Health Supplements'],
    gmapsUrl: 'https://maps.google.com/?q=17.2062,78.4748',
    openingHours: 'Open 24 Hours',
  },
  {
    id: 'thukkuguda-diagnostic-center',
    name: 'Thukkuguda Diagnostic & Dental Clinic',
    category: 'wellness-healthcare',
    categoryLabel: 'Wellness & Healthcare',
    description: 'Digital X-ray, automated blood testing lab, ECG diagnostics, and comprehensive dental health treatments.',
    address: 'Opposite Government School, Village Road, Thukkuguda 501359',
    phone: '+91 91211 44556',
    rating: 4.3,
    reviewCount: 42,
    isVerified: true,
    coordinates: { lat: 17.2038, lng: 78.4725 },
    tags: ['Diagnostic Lab', 'Dental Clinic', 'Blood Test', 'Digital X-Ray'],
    gmapsUrl: 'https://maps.google.com/?q=17.2038,78.4725',
    openingHours: '7:00 AM - 8:30 PM',
  },
  {
    id: 'sanjeevani-ayurvedic-wellness',
    name: 'Sanjeevani Ayurvedic Wellness & Physiotherapy',
    category: 'wellness-healthcare',
    categoryLabel: 'Wellness & Healthcare',
    description: 'Traditional Panchakarma therapy, post-injury joint rehab, spine alignment, and holistic wellness consultations.',
    address: 'Maheshwaram Cross Road, Thukkuguda 501359',
    phone: '+91 98499 88776',
    rating: 4.6,
    reviewCount: 29,
    isVerified: true,
    coordinates: { lat: 17.2095, lng: 78.4785 },
    tags: ['Ayurvedic Wellness', 'Physiotherapy', 'Panchakarma', 'Pain Relief'],
    gmapsUrl: 'https://maps.google.com/?q=17.2095,78.4785',
  ...
  // Retail & Services
  {
    ...
    description: 'Daily fresh groceries, imported packaged foods, household essentials, fruits, and dairy products.',
    ...
    tags: ['Supermarket', 'Groceries', 'Fresh Produce', 'Daily Needs'],
    gmapsUrl: 'https://maps.google.com/?q=17.2075,78.4745',
  ...
  },
  {
    ...
    category: 'retail-services',
    categoryLabel: 'Retail & Services',
    description: 'Automotive diagnostic service station, computer wheel alignment, oil change, and emergency roadside breakdown support.',
    ...
    tags: ['Auto Repair', 'Tire Service', 'Breakdown Support', 'Car Wash'],
    gmapsUrl: 'https://maps.google.com/?q=17.2082,78.4730',
    openingHours: '8:30 AM - 8:00 PM',
  },
  {
    id: 'greenleaf-hardware-electricals',
    name: 'Greenleaf Hardware & Electrical Supplies',
    category: 'retail-services',
    categoryLabel: 'Retail & Services',
    description: 'Building materials, PVC plumbing fittings, electric cables, LED fixtures, paints, and sanitary ware for villa builders.',
    address: 'Near Srisailam Bypass Junction, Thukkuguda 501359',
    phone: '+91 98480 33445',
    rating: 4.1,
    reviewCount: 34,
    isVerified: true,
    coordinates: { lat: 17.2058, lng: 78.4715 },
    tags: ['Hardware Store', 'Electricals', 'Plumbing', 'Construction Supplies'],
    gmapsUrl: 'https://maps.google.com/?q=17.2058,78.4715',
    openingHours: '8:00 AM - 9:00 PM',
  },
  ...
  // Hospitality & Food
  {
    ...
    categoryLabel: 'Hospitality & Food',
    ...
    tags: ['Amusement Park', 'Water Park', 'Resort Stay', 'Weekend Destination'],
    image: '/images/wonderla.jpg',
    gmapsUrl: 'https://maps.google.com/?q=17.2160,78.5250',
  ...
  },
  {
    ...
    category: 'hospitality-food',
    categoryLabel: 'Hospitality & Food',
    description: 'Authentic Hyderabadi dum biryani, North Indian tandoori specialties, and fast casual family dining along Srisailam highway corridor.',
    ...
    tags: ['Hyderabadi Biryani', 'Highway Dhaba', 'Family Restaurant', 'Tandoori'],
    gmapsUrl: 'https://maps.google.com/?q=17.2065,78.4780',
  ...
  },
  {
    ...
    category: 'hospitality-food',
    categoryLabel: 'Hospitality & Food',
    description: 'Furnished single & sharing AC rooms with high-speed Wi-Fi, 3-time South/North meals, and shuttle to TCS/TASL Adibatla campuses.',
    ...
    tags: ['Executive PG Hostel', 'TCS Shuttle', 'AC Rooms', 'Wi-Fi & Food'],
    gmapsUrl: 'https://maps.google.com/?q=17.2050,78.4765',
    openingHours: 'Open 24 Hours',
  },
  ...
  // Aerospace & IT Employers
  {
    ...
    name: 'Tata Advanced Systems Ltd (TASL) - Aerospace SEZ',
    ...
    tags: ['Aerospace SEZ', 'Defense Manufacturing', 'TASL Anchor', 'Adibatla'],
    image: '/images/sez-adibatla.jpg',
    gmapsUrl: 'https://maps.google.com/?q=17.2341,78.5321',
  },
  {
    ...
    category: 'aerospace-it-employers',
    categoryLabel: 'Aerospace / IT Employers',
    description: 'State-of-the-art 1.8 million sq ft IT/ITES campus serving global enterprise software clients.',
    ...
    tags: ['IT Campus', 'TCS Adibatla', 'Software Engineering', 'IT Jobs'],
    image: '/images/tcs-campus.jpg',
    gmapsUrl: 'https://maps.google.com/?q=17.2389,78.5390',
  },
  ...
  // Education
  {
    ...
    gmapsUrl: 'https://maps.google.com/?q=17.2250,78.4900',
  },
  {
    ...
    gmapsUrl: 'https://maps.google.com/?q=17.2090,78.4710',
  },
];
