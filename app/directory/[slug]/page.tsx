            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 sm:p-8 border border-slate-200 dark:border-slate-800 shadow-sm space-y-6">
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  ...
                  {item.isVerified && (
                    <span className="inline-flex items-center space-x-1 text-xs text-violet-600 dark:text-violet-400 font-semibold">
              ...
              <div className="border-t border-slate-100 dark:border-slate-800 pt-6 space-y-3">
                ...
                <div className="relative h-60 w-full rounded-xl overflow-hidden bg-slate-950 flex items-center justify-center border border-slate-700 shadow-inner">
                  <div className="absolute inset-0 bg-[radial-gradient(#8b5cf6_1px,transparent_1px)] [background-size:16px_16px] opacity-25" />
                  <div className="relative z-10 bg-slate-900 text-white p-4 rounded-xl text-center space-y-2 border border-slate-700 shadow-xl">
                    <MapPin className="w-6 h-6 text-violet-400 mx-auto" />
                    ...
                    <a
                      ...
                      className="inline-flex items-center space-x-1 text-xs font-bold text-violet-400 hover:underline pt-1"
                    >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm space-y-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  {item.phone && (
                    <div className="flex items-center space-x-3">
                      ...
                      <a href={`tel:${item.phone}`} className="text-violet-600 dark:text-violet-400 font-bold hover:underline">
                        {item.phone}
                      </a>
                    </div>
                  )}
              ...
              <div className="pt-6 border-t border-slate-100 dark:border-slate-800 space-y-3">
                <div className="p-3 rounded-xl bg-violet-50 dark:bg-violet-950/50 border border-violet-200 dark:border-violet-800 text-xs text-violet-800 dark:text-violet-300">
                ...
                <Link
                  ...
                  className="w-full inline-flex items-center justify-center space-x-2 py-3 rounded-xl bg-violet-600 hover:bg-violet-700 text-white font-bold text-sm shadow transition-all"
                >
              ...
              {item.category === 'real-estate-developers' && (
                <div className="pt-6 border-t border-slate-100 dark:border-slate-800 space-y-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center space-x-1 text-xs font-bold text-violet-600 dark:text-violet-400 hover:underline"
                  >
